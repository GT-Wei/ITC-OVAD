...
class YAMLConfig(BaseConfig):
    def __init__(self, cfg_path: str, **kwargs) -> None:
        ...
        self.load_openai_clip_weights = cfg.get('load_openai_clip_weights', False)
    ...
    def val_dataloader(self, ):
        if self._val_dataloader is None and 'val_dataloader' in self.yaml_cfg:
            ...
            self._val_dataloader.novel_classNum_list = self.yaml_cfg['val_dataloader'].get('novel_classNum_list', [-1])
